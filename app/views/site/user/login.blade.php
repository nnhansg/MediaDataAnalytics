...
<div class="row">
    <div class="col-md-4">
        <a href="{{ URL::to('/') }}">
            <img src="{{ asset('assets/img/Pro-View.png') }}" class="img-responsive" style="margin-top: 100px;">
        </a>
    </div>
        ...
        <form class="form-horizontal" method="POST" action="{{ URL::to('user/login') }}" accept-charset="UTF-8">
            ...
            <fieldset>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="email">{{ Lang::get('confide::confide.username_e_mail') }}</label>
                    <div class="col-md-9">
